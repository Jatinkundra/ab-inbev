...
* **_Image language Translation for various products used overseas_**
   ...
   *  ![alt text](https://github.com/Jatinkundra/ab-inbev/blob/main/image-translation_samples/french_whiskey.jpg?raw=true "Title"= 100x20) -> ![alt text](https://github.com/Jatinkundra/ab-inbev/blob/main/image-translation_samples/converted.jpg?raw=true "Title")
